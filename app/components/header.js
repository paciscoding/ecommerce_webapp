    ...
    return (
        ...
        <nav class="relative max-w-[85rem] w-full mx-auto px-4 sm:flex sm:items-center sm:justify-between sm:px-6 lg:px-8" aria-label="Global">
            ...
            <div class="flex flex-col gap-y-4 gap-x-0 mt-5 sm:flex-row sm:items-center sm:justify-end sm:gap-y-0 sm:gap-x-7 sm:mt-0 sm:ps-7">
                <Link class="font-medium text-white/[.8] hover:text-white sm:py-6" href="../product">Shop</Link>
                <Link class="font-medium text-white/[.8] hover:text-white sm:py-6" href="../post">Blog</Link>
                <Link class="font-medium text-white/[.8] hover:text-white sm:py-6" href="#">About</Link>
            </div>
            </div>
        </nav>
        </header>
